...
async def thumbnail_convert(title, views, duration):
    ...
    font = ImageFont.truetype("./hellbot/helper/resources/Aleo-Bold.otf", 100)
    draw.text((260, 950), f"Title: {title} \n", (300, 300, 300), font=font)
    draw.text((260, 1050), f"Duration: {duration} \n", (300, 300, 300), font=font)
    draw.text((260, 1150), f"Views: {views} \n", (300, 300, 300), font=font)
    img.save("final.png")
    os.remove("temp.png")
    os.remove("thmb.png")
